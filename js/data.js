...
export const phaseDescriptions = {
  ...
  "외교 페이즈": {
    title: "외교 페이즈",
    body: "다른 모둠과 협상합니다. 동맹, 무역, 에너지 협정, 공동 대응 등을 제안하거나 수락합니다.",
    keywords: "학생 활동: 협상 · 제안 · 조건 조율 · 신뢰/배신 판단"
  },
  "행동 입력": {
    title: "행동 입력",
...
export const teacherChecklist = {
  ...
  "외교 페이즈": ["학생들이 협정 제안을 보내도록 안내합니다.", "협정 현황에서 제안을 승인하거나 거절합니다.", "협상 결과를 공지로 정리합니다."],
